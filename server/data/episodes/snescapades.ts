...
const snescapadesEps = [
  ...
  },
  {
    ...
    embedURL:
      "https://podcasters.spotify.com/pod/show/honest-piranha/embed/episodes/Playing-with-Power-November-91-e2kbiur",
    youtubeURL: "https://youtu.be/wWXTMDZgnzE",
    image: "025_PWP_Nov_91.jpg",
    blog: "025_pwp_nov_91.md",
    games: [],
    altText: playingWithPowerAlt("25th", "November 1991"),
    topics: [
      "Sad Chocobos",
      "Stopless Power",
      "Who would you link with?",
      "Is Fred Flintstone a cerial cuck?",
      "Tom & Jerry (90s style)",
  ...
  },
  {
    ...
    episodeNumber: 26,
    length: "35:49",
    published: new Date(2024, monthEnum.jun, 6),
    embedURL:
      "https://podcasters.spotify.com/pod/show/honest-piranha/embed/episodes/Final-Fantasy-II-Edition-e2kjd88",
    youtubeURL: "https://youtu.be/f1MTIeVg7Kg",
    image: "026_FinalFantasyII.jpg",
    blog: "026_final_fantasy_ii.md",
    games: [75, 76],
    altText: snescapadesAlt(
      "26th",
      "the portraits of Rydia, Rosa, Cecil, Kain, and Edge from Final Fantasy IV",
      '"Final Fantasy IV" and "Darius Twin"'
    ),
    topics: [],
    isPublished: true,
  },
  {
    episodeTitle: "Actraiser Edition",
    episodeNumber: 27,
    length: "30:55",
    published: new Date(2024, monthEnum.jun, 15),
    embedURL:
      "https://podcasters.spotify.com/pod/show/honest-piranha/embed/episodes/Actraiser-Edition-e2kubk8",
    youtubeURL: "https://youtu.be/eauiAckqIU8",
    image: "027_Actraiser.jpg",
    blog: "027_actraiser.md",
    games: [77, 78],
    altText: snescapadesAlt(
      "27th",
      "the Master's Avatar from Actraiser jumping and swinging his sword",
      '"Actraiser and Super Ghouls n\' Ghosts"'
    ),
    topics: [],
    isPublished: true,
  },
  {
    episodeTitle: "The Wrap: November 1991",
    episodeNumber: 28,
    length: "49:00",
    published: new Date(2024, monthEnum.jun, 22),
    embedURL:
      "https://podcasters.spotify.com/pod/show/honest-piranha/embed/episodes/The-Wrap-November-91-e2l6ghp",
    youtubeURL: "https://youtu.be/ANnn-uhmzY4",
    image: "028_Wrap_Nov-91.jpg",
    blog: "028_wrap_nov_91.md",
    games: [79, 80, 81, 82, 83, 84],
    altText: theWrapAlt("28th", "November 1991"),
    topics: [],
    isPublished: true,
  },
  {
    episodeTitle: "Playing with Power: February 1994 (Part 1)",
    episodeNumber: 29,
    length: "47:08",
    published: new Date(2024, monthEnum.aug, 15),
    embedURL:
      "https://podcasters.spotify.com/pod/show/honest-piranha/embed/episodes/Playing-with-Power-February-1994-e2n7uqi",
    youtubeURL: "https://youtu.be/xEcOkwAS7fE",
    image: "029_PWP_Feb-94.jpg",
    blog: "029_pwp_feb_94_1.md",
    games: [],
    altText: playingWithPowerAlt("29th", "February 1994"),
    topics: [
      "The dire state of Warner Bros.",
      "That time Elmer Fudd became a god.",
      "Cool Super Mario bedrooms.",
      "NP should have pushed SkyBlazer harder.",
      "Dr. Claw face reveal... or not...",
      "Generically titled sports games.",
    ],
    isPublished: true,
  },
  {
    episodeTitle: "Playing with Power: February 1994 (Part 2)",
    episodeNumber: 30,
    length: "1:02:21",
    published: new Date(2024, monthEnum.sep, 12),
    embedURL:
      "https://podcasters.spotify.com/pod/show/honest-piranha/embed/episodes/Playing-with-Power-February-1994-part-2-e2obb5h",
    youtubeURL: "https://youtu.be/BV8pjjOwBf8",
    image: "030_PWP_Feb-94-2.jpg",
    blog: "030_pwp_feb_94_2.md",
    games: [],
    altText: playingWithPowerAlt("30th", "February 1994"),
    topics: [
      "Nintendo on vacation?",
      "Wait, so IS Samus actually a bounty hunter?",
      "Oh no, there's politics in my video games!",
      "Wow, even Nintendo Power hates these Simpsons games.",
    ],
    isPublished: true,
  },
  {
    episodeTitle: "Ardy Lightfoot Edition",
    episodeNumber: 31,
    length: "50:39",
    published: new Date(2024, monthEnum.sep, 20),
    embedURL:
      "https://podcasters.spotify.com/pod/show/honest-piranha/embed/episodes/Ardy-Lightfoot-Edition-e2ol9k5",
    youtubeURL: "https://youtu.be/BV8pjhjOwBf8",
    image: "031_ArdyLightfoot.jpg",
    blog: "031_ardy_lightfoot.md",
    games: [85, 86, 87],
    altText: snescapadesAlt(
      "31st",
      "The titular character from Ardy Lightfoot (an anthropomorphic cat wearing overalls and a winged cap) making a puzzled expression.",
      "Ardy Lightfoot, Bugs Bunny's Rabbit Rampage, and Flashback: The Quest for Identity"
    ),
    topics: [],
    isPublished: true,
  },
  {
    episodeTitle: "The Ninjawarriors Edition",
    episodeNumber: 32,
    length: "43:30",
    published: new Date(2024, monthEnum.sep, 26),
    embedURL:
      "https://podcasters.spotify.com/pod/show/honest-piranha/embed/episodes/Ninjawarriors-Edition-e2otlv6",
    youtubeURL: "https://youtu.be/RXMof-8AoOQ",
    image: "032_NinjaWarriors.jpg",
    blog: "032_ninjawarriors.md",
    games: [88, 89, 90],
    altText: snescapadesAlt(
      "32nd",
      "Kunoichi from The Ninjawarriors (a robot who looks like a female ninja clad almost completely in red ninja garb revealing only her eyes and long blonde hair) facing the camera.",
      "Ninjawarriors, Micky's Ultimate Challenge, and Alfred Chicken"
    ),
    topics: [],
    isPublished: true,
  },
  {
    episodeTitle: "The Wrap: February 1994",
    episodeNumber: 33,
    length: "53:55",
    published: new Date(2024, monthEnum.oct, 4),
    embedURL:
      "https://podcasters.spotify.com/pod/show/honest-piranha/embed/episodes/The-Wrap-February-1994-e2p7evf",
    youtubeURL: "https://youtu.be/S7Yhzb0Ko4Y",
    image: "033_Wrap_Feb-94.jpg",
    blog: "033_wrap_feb_94.md",
    games: [91, 92, 93, 94, 95, 96, 97, 98, 99],
    altText: theWrapAlt("33rd", "February 1994"),
    topics: [],
    isPublished: true,
  },
  {
    episodeTitle: "Playing with Power: December 1991 (Part 1)",
    episodeNumber: 34,
    length: "44:25",
    published: new Date(2024, monthEnum.oct, 10),
    embedURL:
      "https://podcasters.spotify.com/pod/show/honest-piranha/embed/episodes/Playing-with-Power-December-91-part-1-e2pfbd7",
    youtubeURL: "https://youtu.be/CHqlFGsgAmg",
    image: "034_PWP_Dec-91-1.jpg",
    blog: "034_pwp_Dec_91_1.md",
    games: [],
    altText: playingWithPowerAlt("34th", "December 1991"),
    topics: [
      "Nintendo Power did have some REALLY talented readers!",
      "A sequel to a movie tie in game NOT based on the movie’s sequel.",
      "Glitches in Mario World.",
      "Things coming out of sewers.",
    ],
    isPublished: true,
  },
  {
    episodeTitle: "Playing with Power: December 1991 (Part 2)",
    episodeNumber: 35,
    length: "51:22",
    published: new Date(2024, monthEnum.oct, 22),
    embedURL:
      "https://podcasters.spotify.com/pod/show/honest-piranha/embed/episodes/Playing-with-Power-December-91-part-2-e2q0k92",
    youtubeURL: "https://youtu.be/yrtoAziK5uU",
    image: "035_PWP_Dec-91-2.jpg",
    blog: "035_PWP_Dec_91_2.md",
    games: [],
    altText: playingWithPowerAlt("35th", "December 1991"),
    topics: [
      "The many ways to play Metroid 2.",
      "Unpleasant images of Master Higgins.",
      "How many Game Boy games came out in North America?",
      "Cool custom Game Boys.",
      "Questionable high scores.",
    ],
    isPublished: true,
  },
  // {
